...
### Phase 5: Gamified FIRE Super Dashboard & Precision UX Overhaul (완료 — 2026-08-01)
...
- [x] **#18-6** '순자산' ➔ '총자산 (Total Assets)' & '실시간' ➔ '현재/전계좌통합' 전면 단어 개편 완료
- [x] **#18-7** 자산 금액 축약 표기(30만엔) 전면 금지 ➔ 100% 실수치(`￥301,000`) 표기 완결
- [x] **#18-8** 게이밍 레벨 연산 공식 & 4대 퀘스트 실시간 진척률(%) 프로그레스 바 신설
- [x] **#18-9** '이번 달 저축·투자 가능 잉여금 (Net Surplus)' 직관적 설명 및 툴팁 잘림 방지 (`z-[9999]`)
