...
## ✅ Phase 5: Gamified FIRE Super Dashboard, Precision UX & Transparency (완료 — 2026-08-01)
...
| #18-6 | **'순자산' ➔ '총자산 (Total Assets)' 전면 용어 통일** — 헷갈리는 순자산 문구 100% 삭제 | ✅ |
| #18-7 | **자산 금액 축약 표기(30만엔) 전면 금지 ➔ 100% 실수치(`￥301,000`) 표기 완결** | ✅ |
| #18-8 | **게이밍 레벨 연산 공식 & 4대 퀘스트 실시간 진척률(%) 프로그레스 바 신설** | ✅ |
| #18-9 | **'이번 달 저축·투자 가능 잉여금 (Net Surplus)' 직관적 설명 및 툴팁 잘림 방지 (`z-[9999]`)** | ✅ |
...
| 게이밍 레벨 투명성 | 레벨 연산 근거 불분명 | 기본 자산 레벨 + 저축률 보너스 공식 공개 & 퀘스트별 % 진행률 바 제공 | ✅ |
| 잉여금 설명 | 생소한 잉여 여력 문구 | `이번 달 저축·투자 가능 잉여금 (수입 - 지출)` 개념 직관화 | ✅ |
| 툴팁 잘림 현상 | 카드 테두리에 잘림 | `z-[9999]` 및 overflow 구조 개선으로 100% 깨끗한 팝업 보장 | ✅ |
| 용어 직관성 | '순자산', '실시간' 혼동 | '총자산 (Total Assets)' 전면 통합 & '현재/전계좌합산' 표기 | ✅ |
