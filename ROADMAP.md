...
## ✅ Phase 5: Gamified FIRE Super Dashboard, MoM Engine Redesign & Terminology Cleanup (완료 — 2026-08-01)
...
| #18-6 | **'순자산' ➔ '총자산 (Total Assets)' & '실시간' ➔ '현재/전계좌통합' 전면 단어 개편** — 불필요하고 헷갈리는 금융 용어 100% 삭제 및 직관적 총자산 통일 | ✅ |
| #19 | **게이밍 재정 성장 랭킹 & FIRE 퀘스트 업적 카드** — Lv.1~99 XP 바 및 4대 배지 (`FinancialLevelCard.tsx`) | ✅ |
...
| 항목 | 이전 상태 | 개선 결과 | 상태 |
|---|---|---|:---:|
| 용어 직관성 | '순자산', '실시간' 등 혼동 | '순자산' ➔ '총자산 (Total Assets)' 100% 교체 & '실시간' ➔ '현재/전 계좌 통합' 표기 | ✅ |
| MoM 비교 엔진 | 오늘 날짜 비교로 0엔 버그 | 최신 마감(7월) vs 직전 마감(6월) 자동 비교 연산 (`+5만엔` 흑자 표기) | ✅ |
